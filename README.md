...
To understand the interaction between the outcomes of the kickstarter fundraising campaigns based on their launch dates required reinterpreting the 'date' column 
